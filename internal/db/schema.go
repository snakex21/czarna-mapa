...
// FullSchema zawiera wszystkie CREATE TABLE dla SQLite.
// Odpowiednik FULL_SCHEMA z Rustowego schema.rs.
const FullSchema = `
-- =============================================================================
...
('map_calibration', '{"sw":{"lat":50.0414,"lng":21.2261},"ne":{"lat":50.0814,"lng":21.2661}}',
 'Wspolrzedne kalibracji mapy historycznej'),
('map_defaults', '{"center":{"lat":50.0614,"lng":21.2461},"zoom":14}',
 'Domyslny widok startowy mapy'),
('protokoly_path', '',
 'Sciezka do folderu ze skanami protokolow (pusta = szukaj automatycznie)');
`
